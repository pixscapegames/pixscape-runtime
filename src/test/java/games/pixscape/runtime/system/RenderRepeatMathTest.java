...
public class RenderRepeatMathTest {
    ...
    public void noRepeatVisibleBaseEmitsOneQuad() {
        ...
        Assert.assertEquals(1, RenderRepeatMath.visibleCount(range));
    ...
    public void repeatXEmitsExpectedVisibleCopies() {
        ...
        Assert.assertEquals(5, RenderRepeatMath.visibleCount(range));
    ...
    public void repeatXYEmitsExpectedGrid() {
        ...
        Assert.assertEquals(25, RenderRepeatMath.visibleCount(range));
    ...
    public void negativeViewportCoordinatesUseFloor() {
        ...
        Assert.assertEquals(4, RenderRepeatMath.visibleCount(range));
    ...
    public void baseOutsideViewportStillFindsRepeatedCopy() {
        ...
        Assert.assertEquals(3, RenderRepeatMath.visibleCount(range));
    ...
    public void guardCapsTooManyCopies() {
        ...
        Assert.assertEquals(1024, RenderRepeatMath.visibleCount(range));
    ...
    private boolean calculate(
            ...
            byte repeatFlags,
            int maxDraws) {
        return RenderRepeatMath.calculateVisibleRange(
                viewportMinX,
                viewportMaxX,
                viewportMinY,
                viewportMaxY,
