...
public final class SortKey64 {
    ...
    // Unpack debug
    public static int unpackLayerOrdered(long k){ return (int)((k >>> ORD_LAYER_SHIFT) & LAYER_MASK); }
    public static int unpackZOrdered(long k){
        long zb = (k >>> ORD_Z_SHIFT) & Z_MASK;
        return (int)(zb - Z_BIAS);
    }
    public static int unpackPassOrdered(long k) { return (int)((k >>> ORD_PASS_SHIFT) & PASS_MASK); }
    public static int unpackTieOrdered(long k)  { return (int)((k >>> ORD_TIE_SHIFT) & TIE_MASK); }
